...
{
    public partial class txtCargaHoraria : Form
    {
        public txtCargaHoraria()
        {
            InitializeComponent();
        }
        ...
        private void CadastroFuncionarios_Load(object sender, EventArgs e)
        {
            ...
            this.funcionariosBindingSource.DataSource =
                DataContextFactory.DataContext.Funcionarios;
        }
        ...
        private bool ValidarCampos()
        {
            ...
            if (string.IsNullOrWhiteSpace(txtNome.Text) ||
                ...
                string.IsNullOrWhiteSpace(mskDataAdmissao.Text) ||
                string.IsNullOrWhiteSpace(mskCargaHoraria.Text))
            {
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            {
                this.funcionariosBindingSource.RemoveCurrent();
                DataContextFactory.DataContext.SubmitChanges();
        ...
        private void txtNome_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true; // Impede a entrada de caracteres que não sejam letras
            }
        }
        ...
        {
            if (DateTime.TryParse(mskDataAdmissao.Text, out DateTime date))
            {
                ...
                {
                    MessageBox.Show("A data deve estar entre 01/01/1753 e 31/12/9999.", "Data inválida", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            {
                MessageBox.Show("Data inválida! Por favor, insira uma data no formato correto.", "Data inválida", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                mskDataAdmissao.Clear();
                mskDataAdmissao.Focus();
            }
        }
